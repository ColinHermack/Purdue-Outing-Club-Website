...
let leadershipCategories = [
    ...
    },
    {
        ...
        positions: ['Secretary of Sports', 'Secretary of Treasury', 'Secretary of Outreach', 'Treasurer', 'Health & Safety']
    },
    {
        branch: 'Public Relations',
        positions: ['Fundraising, Sponsorship, & Alumni', 'Diversity & Community Outreach', 'Social Media Coordinator', 'Webmaster', 'Data Analyst', 'Cheese Consultant']
    },
    {
        branch: 'Event Planning',
        positions: ['POCAR Race Coordinator', 'POCAR Volunteer Coordinator', 'POCAR Registration Coordinator', 'POCtoberfest Coordinator']
    },
    {
        branch: 'Backpacking',
    ...
    {
        branch: 'Climbing',
        positions: ['Head Climbing Officer', 'Climbing Team Captain', 'Climbing Officer']
    },
    {
        branch: 'Fishing',
